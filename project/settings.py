...
SECRET_KEY = 'django-insecure-s3*c(08-zj2spnhcbzff#u)zg93s-y2*t_qq-h0-fsy66dcdal'
...
AUTH_USER_MODEL = 'base.MarketUser'
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER") # Update with your email username
...
# Paypal
PAYPAL_MODE = "sandbox" # Change to "live" for production or "sandbox" for development
